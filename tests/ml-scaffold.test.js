...
test('ml training script targets the interchangeable model candidates', () => {
  ...
  assert.match(script, /"random_forest": RandomForestClassifier/)
  assert.match(script, /"gradient_boosting": GradientBoostingClassifier/)
  assert.match(script, /"gaussian_nb": GaussianNB\(var_smoothing=/)
  assert.match(script, /manifest\.json/)
  assert.match(script, /feature_columns/)
  assert.match(script, /DEFAULT_FEATURE_COLUMNS/)
  assert.match(script, /meta_previous_difficulty/)
  assert.match(script, /height_delta/)
